...
### 1. [Warden (`/warden`)](https://www.google.com/search?q=./warden) - *Kernel-Level Process Governance*
...
### 2. [Nozzle Suite (`/nozzle`)](https://www.google.com/search?q=./nozzle) - *IoT Telemetry & Multithreaded Dashboards*
...
### 3. [Orchestrator (`/orchestrator`)](https://www.google.com/search?q=./orchestrator) - *Temporal Data Synthesis Pipeline*
...
### 4. [KeepAwake (`/keepawake`)](https://www.google.com/search?q=./keepawake) - *Session Persistence Daemon*
