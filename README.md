...
### 1. [Warden (`/warden`)](/warden) - *Kernel-Level Process Governance*
...
### 2. [Nozzle Suite (`/nozzle`)](/nozzle) - *IoT Telemetry & Multithreaded Dashboards*
...
### 3. [Orchestrator (`/orchestrator`)](/orchestrator) - *Temporal Data Synthesis Pipeline*
...
### 4. [KeepAwake (`/keepawake`)](/keepawake) - *Session Persistence Daemon*
